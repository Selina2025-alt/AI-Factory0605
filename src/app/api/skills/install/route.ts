    ...
    return NextResponse.json(
      {
        ...
        message:
          "Custom GitHub skill installation is local-only in the current MVP. Use built-in skills in Vercel, or keep APP_STORAGE_PROVIDER=local for local skill installation."
      },
      { status: 501 }
    );
  }
